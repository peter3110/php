<?php
	...
	class CuentaBancariaTestDeUnidad extends TestCase {
		...
		// OBSERVACION: ESTE TEST NO IRÍA EN LOS TESTS DE INTEGRACIÓN
		...
		public function testExtraccionDeUnPesoEnNuevaCuentaBancariaSinPrevioDeposito() {
			...
			$stub_calculadora = $this->createMock(Calculadora::class);
			$stub_calculadora->method('restarAPesos')
		...
		*/
		...
		public static function proveedorUnDepositoUnaExtraccionSaldoEnPesosCSV() {
			return new CsvFileIterator($DIR_BASE . 'data/csvFile.csv');
		}
		/**
